        ...
        <div>
            <nav className="fixed top-0 w-full bg-zinc-950 shadow-2xl z-50">
                <ul className="flex justify-end p-4">
                    <li>
                        <a onClick={() => scrollToSection('home')} className="text-white font-bold m-6 cursor-pointer">Home</a>
                    </li>
                    <li>
                        <a onClick={() => scrollToSection('about')} className="text-white font-bold m-6 cursor-pointer">About Me</a>
                    </li>
                    <li>
                        <a onClick={() => scrollToSection('projects')} className="text-white font-bold m-6 cursor-pointer">Projects</a>
                    </li>
                </ul>
            </nav>
            ...
            <div id="home" className="min-h-screen flex items-center justify-center bg-black">
                ...
                >
                    ...
                    <p className="text-2xl text-white">
                        Hi. I am Jeremy, a Computer Science Undergraduate from the National University of Singapore
                    </p>
                </motion.div>
            </div>

            {/* Separator */}
            <hr className="border-t-4 border-white mx-auto rounded-2xl w-3/4"/>
            ...
            <div id="about" className="min-h-screen flex items-center justify-center bg-black">
                ...
                >
                    ...
                    <p className="mt-4 text-xl text-white">I am a passionate developer...</p>
                </motion.div>
            </div>
            ...
            <div id="projects" className="min-h-screen flex items-center justify-center bg-black">
                ...
                >
                    ...
                    <div className="rounded-2xl bg-white w-96 h-52 flex justify-center items-center">
